...
st.markdown(
    ...
    <div class='banner-container'>
        <img src='https://res.cloudinary.com/highereducation/images/f_auto,q_auto/v1664371057/learnhowtobecome.org/04-Resume-Guide-1203940958_3962dd640/04-Resume-Guide-1203940958_3962dd640.jpg?_i=AA' class='banner-img'>
    </div>
    """,
...
with st.sidebar:
    ...
    job_description = st.text_area("Enter the job description", height=200, key="job_description")
    st.markdown("<h2 style='font-size:40px;'>📂 Upload Resumes</h2>", unsafe_allow_html=True)
    uploaded_files = st.file_uploader("Upload PDF resumes", type=["pdf"], accept_multiple_files=True)

# Main content
st.markdown("---")
st.markdown("<h2 style='font-size:40px;'>ℹ How to Use</h2>", unsafe_allow_html=True)
